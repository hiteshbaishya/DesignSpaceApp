...
class PrintingDigitalColor extends StatefulWidget {
  const PrintingDigitalColor({super.key});

  @override
  State<PrintingDigitalColor> createState() => _PrintingDigitalColorState();
}

class _PrintingDigitalColorState extends State<PrintingDigitalColor> {
  ...
  Future<dynamic> fetchData() async {
    try {
      ...
      final uri = Uri.parse(
          "http://10.177.48.186:8080/DesignSpace/API/PrintingDigitalColor");
