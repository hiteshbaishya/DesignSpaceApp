...
class PrintingOffsetOneColor extends StatefulWidget {
  const PrintingOffsetOneColor({super.key});

  @override
  State<PrintingOffsetOneColor> createState() => _PrintingOffsetOneColorState();
}

class _PrintingOffsetOneColorState extends State<PrintingOffsetOneColor> {
  ...
  Future<dynamic> fetchData() async {
    try {
      ...
      final uri = Uri.parse(
          "http://10.177.48.186:8080/DesignSpace/API/PrintingOffsetOneColor");
