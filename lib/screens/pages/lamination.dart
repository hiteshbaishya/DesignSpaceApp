...
class Lamination extends StatefulWidget {
  const Lamination({super.key});

  @override
  State<Lamination> createState() => _LaminationState();
}

class _LaminationState extends State<Lamination> {
  ...
  Future<dynamic> fetchData() async {
    try {
      ...
      final uri = Uri.parse(
          "http://10.177.48.186:8080/DesignSpace/API/Lamination");
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                String readyText =
                    ...
                    "${data[index]["printing_type"]}#${data[index]["LaminationType"]}#"
                    "${data[index]["LaminationSide"]}";
