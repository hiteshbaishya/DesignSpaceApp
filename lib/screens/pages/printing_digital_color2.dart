...
class PrintingDigitalColor2 extends StatefulWidget {
  const PrintingDigitalColor2({super.key});

  @override
  State<PrintingDigitalColor2> createState() => _PrintingDigitalColor2State();
}

class _PrintingDigitalColor2State extends State<PrintingDigitalColor2> {
  ...
  Future<dynamic> fetchData() async {
    try {
      ...
      final uri = Uri.parse(
          "http://10.177.48.186:8080/DesignSpace/API/PrintingDigitalColor2");
