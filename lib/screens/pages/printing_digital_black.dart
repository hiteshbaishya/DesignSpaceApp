...
class PrintingDigitalBlack extends StatefulWidget {
  const PrintingDigitalBlack({super.key});

  @override
  State<PrintingDigitalBlack> createState() => _PrintingDigitalBlackState();
}

class _PrintingDigitalBlackState extends State<PrintingDigitalBlack> {
  ...
  Future<dynamic> fetchData() async {
    try {
      ...
      final uri = Uri.parse(
          "http://10.177.48.186:8080/DesignSpace/API/PrintingDigitalBlack");
